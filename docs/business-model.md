...
Independent public-sector market-entry compliance for Somalia.

- Department of Public Procurement, Ministry of Finance -- confirmed
  real directly (mof.gov.so's own page: 'arbitrate and award tenders
  for Federal Government and any other institutions ... coupled with
  the registration and grading of contractors who are willing to do
...
- Beneficial Ownership Registration Regulation (Ministry of Commerce
  and Industry, July 2024) -- its own text, read directly in full,
  defines a Beneficial Owner as a natural person holding more than 10%
  of a company's shares or de facto control, requires disclosure to the
...
- Tax Compliance Certificate (SHCN/TCC) -- required of government
  ...
  Decree (Xeer Ra'iisul Wasaare Lr. 138, 24 August 2023), read directly.
...
HARD hold that no human approval can override.
