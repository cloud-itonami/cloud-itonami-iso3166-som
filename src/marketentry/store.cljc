(ns marketentry.store
  "SSoT for the Somalia (SOM) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:beneficial-owner-pct` / `:beneficial-owner-control?` /
  `:beneficial-owner-disclosed-within-deadline?` /
  `:beneficial-owner-noncompliant-days` are ground truth for the
  `beneficial-owner-registration-noncompliant` flagship check (Ministry
  of Commerce and Industry Beneficial Ownership Registration
  Regulation, July 2024); `:requires-tcc-record?` /
  `:tcc-record-verified?` are ground truth for the conditional Tax
  Compliance Certificate check (Xeer Ra'iisul Wasaare Lr. 138,
  24/08/2023). All operator names below are FICTIONAL demo entities."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Hodan Trading Company" :portal "no self-service e-procurement portal found (see marketentry.facts)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :beneficial-owner-pct 5 :beneficial-owner-control? false :beneficial-owner-disclosed-within-deadline? false :beneficial-owner-noncompliant-days 0
             :requires-tcc-record? true :tcc-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SOM" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "no self-service e-procurement portal found (see marketentry.facts)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :beneficial-owner-pct 5 :beneficial-owner-control? false :beneficial-owner-disclosed-within-deadline? false :beneficial-owner-noncompliant-days 0
             :requires-tcc-record? true :tcc-record-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Banadir Logistics Ltd" :portal "no self-service e-procurement portal found (see marketentry.facts)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SOM" :status :intake}
    "eng-4" {:id "eng-4" :operator "Jubaland Construction Co" :portal "no self-service e-procurement portal found (see marketentry.facts)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :beneficial-owner-pct 35 :beneficial-owner-control? false :beneficial-owner-disclosed-within-deadline? false :beneficial-owner-noncompliant-days 18
             :requires-tcc-record? true :tcc-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SOM" :status :intake}
    "eng-5" {:id "eng-5" :operator "Mogadishu Freight Services" :portal "no self-service e-procurement portal found (see marketentry.facts)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :beneficial-owner-pct 5 :beneficial-owner-control? false :beneficial-owner-disclosed-within-deadline? false :beneficial-owner-noncompliant-days 0
             :requires-tcc-record? true :tcc-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "SOM" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               beneficial-owner-pct beneficial-owner-control? beneficial-owner-disclosed-within-deadline?
                               beneficial-owner-noncompliant-days
                               requires-tcc-record? tcc-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? beneficial-owner-pct)          (assoc :engagement/beneficial-owner-pct beneficial-owner-pct)
    (some? beneficial-owner-control?)     (assoc :engagement/beneficial-owner-control? beneficial-owner-control?)
    (some? beneficial-owner-disclosed-within-deadline?) (assoc :engagement/beneficial-owner-disclosed-within-deadline? beneficial-owner-disclosed-within-deadline?)
    (some? beneficial-owner-noncompliant-days) (assoc :engagement/beneficial-owner-noncompliant-days beneficial-owner-noncompliant-days)
    (some? requires-tcc-record?)          (assoc :engagement/requires-tcc-record? requires-tcc-record?)
    (some? tcc-record-verified?)          (assoc :engagement/tcc-record-verified? tcc-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/beneficial-owner-pct :engagement/beneficial-owner-control? :engagement/beneficial-owner-disclosed-within-deadline?
   :engagement/beneficial-owner-noncompliant-days
   :engagement/requires-tcc-record? :engagement/tcc-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :beneficial-owner-pct (:engagement/beneficial-owner-pct m)
     :beneficial-owner-control? (boolean (:engagement/beneficial-owner-control? m))
     :beneficial-owner-disclosed-within-deadline? (boolean (:engagement/beneficial-owner-disclosed-within-deadline? m))
     :beneficial-owner-noncompliant-days (:engagement/beneficial-owner-noncompliant-days m)
     :requires-tcc-record? (boolean (:engagement/requires-tcc-record? m))
     :tcc-record-verified? (boolean (:engagement/tcc-record-verified? m))
