(ns marketentry.marketentryllm
  ...
  the Somalia (SOM) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "beneficial-owner-pct=" (:beneficial-owner-pct e)
                        " beneficial-owner-control?=" (:beneficial-owner-control? e)
                        " beneficial-owner-disclosed-within-deadline?=" (:beneficial-owner-disclosed-within-deadline? e)
                        " tcc-record-verified?=" (:tcc-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-tcc-record? e))
                              (:tcc-record-verified? e)))
                   0.9 0.3)}))
